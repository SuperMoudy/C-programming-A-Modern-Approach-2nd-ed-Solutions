...
/************************************************************
 * erase: Prompts the user to enter a part number. Prints   *
 *         an error message if the part doesn't exist;      *
 *         otherwise, erases the part from the database     *
 *         then updates the database list.                  *
 *                                                          *
 ************************************************************/
...
void erase(void)
{
	...
	if(cur == NULL) // number is not found
	{
		printf("Part not found\n");
		return;
	}
